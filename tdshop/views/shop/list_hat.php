			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-3">
						...
						<form action="?act=list_hat" method="post">
							<div class="price_filter slidecontainer">
							<div id="slider-range"></div>
								<div class="price_slider_amount">
									<input type="text"  name="price_mu" />
									<div class="row">
										<div class="col-sm-8 price_slider_amount" >
											<input type="text" id="amount" name="price_mu" />
										</div>
										<div class="col-sm-4">
						...
						<div class="pagination">
					       <?php if ($data_tong >= 9) {
								for ($i = 1; $i <= $data_tong / 9; $i++) { ?>
									<a class="active chinh_menu" href="?act=list_hat&trangmu=<?= $i ?>"><?= $i ?></a>
							<?php }
							}
							?>
					    </div>
