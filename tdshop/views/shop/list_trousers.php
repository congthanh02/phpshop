			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-lg-6">
						<span>Trang chủ / Sản phẩm/ Thời trang Quần</span>
					</div>
					<div class="col-sm-3 col-lg-3">
				...
				<div class="row">
					<div class="col-sm-3">
						...
						<form action="?act=list_trousers" method="post">
							<div class="price_filter slidecontainer">
							<div id="slider-range"></div>
								<div class="price_slider_amount">
									<input type="text"  name="price_quan" />
									<div class="row">
										<div class="col-sm-8 price_slider_amount" >
											<input type="text" id="amount" name="price_quan" />
										</div>
										<div class="col-sm-4">
						...
						<div class="pagination">
					       <?php if ($data_tong >= 9) {
								for ($i = 1; $i <= $data_tong / 9; $i++) { ?>
									<a class="active chinh_menu" href="?act=list_trousers&trangquan=<?= $i ?>"><?= $i ?></a>
							<?php }
							}
							?>
					    </div>
