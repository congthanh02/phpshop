			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-lg-6">
						<span>Trang chủ / Sản phẩm/ Thời trang Giày</span>
					</div>
					<div class="col-sm-3 col-lg-3">
				...
				<div class="row">
					<div class="col-sm-3">
						...
						<form action="?act=list_shoes" method="post">
							<div class="price_filter slidecontainer">
							<div id="slider-range"></div>
								<div class="price_slider_amount">
									<input type="text"  name="price_giay" />
									<div class="row">
										<div class="col-sm-8 price_slider_amount" >
											<input type="text" id="amount" name="price_giay" />
										</div>
										<div class="col-sm-4">
