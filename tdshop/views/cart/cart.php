...
<div class="container">
            <div id="form">
                                    ...
                                    <div class="cart_quantity">
                                        <form action="" method="POST">
                                            <div class="quantity__butons buttons_added">
                                                ...
                                                <input type="number" step="1" min="1" max="<?= $value['Quantity'] ?>" name="quantity" value="<?= $value['Quantity'] ?>" title="Qty" class="input-text qty text" size="4" pattern="" inputmode="">
                ...
                <input type="button" name="next-step" class="next-step stardust-button--primary  btn-checkout" value="Mua hàng">                                      
                </fieldset>
                <fieldset>
                        ...
                        <div class="row row_wrapper">
                            <div class="wrapper">
                                ...
                                <div class="custom_select">
                                    ...
                                    <div class="inputfield">
                                    <label>Địa chỉ</label>
                                    <textarea id="issue" class="textarea" name="address" required placeholder="Ví dụ: 470 Trần Đại Nghĩa" rows="1"></textarea>
                                    </div>
                                    <div class="inputfield">
                            ...
                            <div class="payment-method">
                                ...
                                <div class="radio-input">
                                    <input id="credit_card" type="radio" name="shippingtype" required value="Thanh toán bằng thẻ tín dụng">
                                ...
                                <div class="radio-input">
                                    <input id="paypal" type="radio" name="shippingtype" required value="Thanh toán bằng PayPal">
                                ...
                                <div class="radio-input">
                                    <input id="e-wallet" type="radio" name="shippingtype" required value="Thanh toán bằng ví điện tử">
                                ...
                                <div class="radio-input">
                                    <input id="cod" type="radio" name="shippingtype" required value="Thanh toán khi nhận hàng">
                            ...
                            <div class="form">
                                <div class="inputfield">
                                <input type="text" class="input" placeholder="Nhập mã giảm giá" style="margin-right: 10px;">
                                        ...
                                        <div class="cart_flex">
                                            <div class="cart_product">
                                                <div class="cart_product__items">
                                                    ...
                                                    <div class="product__items__name">
                                                        <a class="product-name" href="?act=detail&id=<?= $value['ProductID'] ?>" title="<?= $value['ProductName'] ?>"><?= $value['ProductName']?></a>
                                                        <div class="_2o95Vf" style="background-image: url(&quot;https://cf.shopee.vn/file/bd5328df650cdbfda6340d64144fd76e&quot;);"></div>
                                            ...
                                            <div class="cart_price">
                                                <div>
                                                    <span class="cart_price__items"><?= $value['Price'] ?></span>
                                                </div>
                                            </div>
                                            <div class="cart_quantity">
                                            ...
                                            <div class="cart_total">
                                                <span><?= number_format($value['ThanhTien']) ?></span>
                                            </div>
                                            <div class="cart_delete">
                                            </div>
                                        </div>
                    ...
                    <div class="form-total-checkout">
                        ...
                        <div class="total__checkout checkout__item__price "><?=number_format($count)?> VNĐ</div>
                        ...
                        <div class="total__checkout price-checkout checkout__item__price" name="total-order"><?=number_format($count+32800)?> VNĐ</div>
                    </div>
